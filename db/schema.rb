...
ActiveRecord::Schema[7.0].define(version: 2022_12_06_232427) do
  ...
  create_table "areas", force: :cascade do |t|
    ...
    t.index ["area_category_id"], name: "index_areas_on_area_category_id"
  ...
  add_foreign_key "areas", "area_categories"
